...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/28 17:16:19 by raveriss          #+#    #+#             */
/*   Updated: 2024/02/28 17:16:21 by raveriss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_elem(t_data *data)
{
	...
	if (!data->elem.so_path || !data->elem.no_path \
		|| !data->elem.ea_path || !data->elem.we_path \
		|| data->elem.colors_c[0] == -1 || data->elem.colors_c[1] == -1 \
		|| data->elem.colors_c[2] == -1 || data->elem.colors_f[0] == -1 \
		|| data->elem.colors_f[1] == -1 || data->elem.colors_f[2] == -1)
